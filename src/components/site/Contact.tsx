        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <Reveal delay={80}>
            <h2 className="mt-5 text-4xl md:text-6xl font-display font-bold">
              Come visit us <span className="text-gradient-fire">today</span>
            </h2>
          </Reveal>
        </div>
        ...
        <div className="mt-14 grid lg:grid-cols-5 gap-6">
            ...
            <div className="rounded-3xl border bg-card p-6 sm:p-8 h-full shadow-soft">
              ...
              <div className="mt-6 space-y-5 text-sm">
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Address</div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <div className="text-xs uppercase tracking-[0.2em] text-muted-foreground">Call to order</div>
                    <a href={RESTAURANT.phoneHref} className="mt-1 block font-display text-xl text-[var(--chili)]">
                      {RESTAURANT.phone}
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-8 flex flex-wrap gap-2">
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-gradient-fire px-5 py-3 text-sm font-medium text-cream shadow-glow hover:scale-[1.03] transition"
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-secondary text-secondary-foreground px-5 py-3 text-sm font-medium hover:scale-[1.03] transition"
                >
          ...
          <Reveal className="lg:col-span-3" delay={120}>
            <div className="relative h-full min-h-[420px] rounded-3xl overflow-hidden shadow-soft border">
              <iframe
                title="Fiesta Mexicana on Google Maps"
                src={embed}
                loading="lazy"
