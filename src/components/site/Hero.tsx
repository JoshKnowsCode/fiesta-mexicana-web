  ...
  return (
    <section id="top" className="relative min-h-[100svh] w-full overflow-hidden bg-gradient-night">
      ...
      <div className="absolute inset-0">
        ...
        />
        {/* Dark vignette - stronger at edges, lighter in center */}
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-7xl flex-col justify-center px-6 pt-32 pb-32 text-cream" style={{ color: "var(--cream)" }}>
        <div className="max-w-2xl">
          ...
          <h1 className="font-display text-[clamp(3rem,8vw,6.5rem)] font-bold leading-[0.9] tracking-tight">
            Food Made<br />
            <span className="text-gradient-fire italic">From the Heart</span>
          </h1>

          <p className="mt-7 max-w-lg text-base md:text-lg text-white/75 leading-relaxed font-light">
            Handmade tortillas, slow-cooked meats, and family recipes passed down for generations—just the way <em className="text-white/90 not-italic font-normal">abuela</em> made them.
          </p>
      ...
      {/* SVG wave blending into the next section */}
